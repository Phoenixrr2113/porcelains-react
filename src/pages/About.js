							...
							<div className='row row-25 align-items-center'>
								<div className='col-lg-6 col-12 mb-30'>
									<div className='about-image-two'>
										<img
											src='http://porcelainsunlimited.com/wp-content/uploads/2014/10/urn3.png'
											alt=''
										/>
							...
							<div className='about-wrapper row'>
								<div className='col-sm-6 col-12 order-1 order-lg-2'>
									<div className='about-image about-image-1'>
										<img
											src='http://porcelainsunlimited.com/wp-content/uploads/2018/11/mausoleum3-optimized.jpg'
											alt=''
										/>
									</div>
								</div>
								<div className='col-sm-6 col-12 order-2 order-lg-3'>
									<div className='about-image about-image-2'>
										<img
											src='http://porcelainsunlimited.com/wp-content/uploads/2013/01/Slider_1.jpg'
											alt=''
										/>
									</div>
								</div>
