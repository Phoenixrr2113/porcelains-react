                    ...
                    <div className="header-top-bar">
                        ...
                        <div className="row align-items-center">
                            ...
                            <div className="top-bar-right-wrapper">
                                <a href={`${process.env.PUBLIC_URL}/contact-us`} className="ht-btn ht-btn--default d-inline-block">Have a Question?</a>
                            </div>
                            </div>
                        </div>
                        </div>
                                ...
                                <div className="header-info-wrapper align-items-center">
                                    ...
                                    <div className="logo">
                                        <Link to = {`${process.env.PUBLIC_URL}/`}>
                                            <img src="https://res.cloudinary.com/dlrdfp08e/image/upload/v1562167696/porcelains/Outlook-2p431lzt.png" className="img-fluid" alt="Logo" />
                                        </Link>
                                    </div>
                                    {/* header contact info */}
                                    ...
                                    <div className="header-navigation header-navigation--header-default position-relative">
                                        ...
                                        <nav>
                                            <ul>
                                            	...
                                            	<li>
																								<Link to={`${process.env.PUBLIC_URL}/about`}>ABOUT</Link></li>
                                            	<li>
                                            	  <Link to={`${process.env.PUBLIC_URL}/product-list`}>PRODUCTS</Link>   
                                            	</li>
                                            	<li>
																								<Link to={`${process.env.PUBLIC_URL}/contact-us`}>CONTACT</Link>
																							</li>
                                            	<li>
